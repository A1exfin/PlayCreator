from Enum_flags import TeamType, FillType, SymbolType
...
class PlayersData:
    def __init__(self, field_data):
        ...
        self.offence_football = (
            (TeamType.offence, 'C', '#000000', '#000000', FillType.white, self.center_center_football, - self.player_size / 2),
            (TeamType.offence, 'RG', '#000000', '#000000', FillType.white, self.center_center_football + 23, - self.player_size / 2),
            (TeamType.offence, 'RT', '#000000', '#000000', FillType.white, self.center_center_football + 46, - self.player_size / 2),
            (TeamType.offence, 'LG', '#000000', '#000000', FillType.white, self.center_center_football - 23, - self.player_size / 2),
            (TeamType.offence, 'LT', '#000000', '#000000', FillType.white, self.center_center_football - 46, - self.player_size / 2),
            (TeamType.offence, 'X', '#000000', '#000000', FillType.white, self.center_center_football + 230, - self.player_size / 2),
            (TeamType.offence, 'Y', '#000000', '#000000', FillType.white, self.center_center_football + 130, - self.player_size / 2 + 13),
            (TeamType.offence, 'Z', '#000000', '#000000', FillType.white, self.center_center_football - 230, - self.player_size / 2),
            (TeamType.offence, 'H', '#000000', '#000000', FillType.white, self.center_center_football - 130, - self.player_size / 2 + 13),
            (TeamType.offence, 'Q', '#000000', '#000000', FillType.white, self.center_center_football, - self.player_size / 2 + 50),
            (TeamType.offence, 'F', '#000000', '#000000', FillType.white, self.center_center_football, - self.player_size / 2 + 75)
        )

        self.additional_player_football = (TeamType.offence_add, 'V', '#000000', '#000000', FillType.white, self.center_center_football + 90, - self.player_size / 2 + 13)

        self.defence_football = (
            (TeamType.defence, 'Т', '#000000', '#000000', SymbolType.letter, self.center_center_football - 10, - self.player_size / 2 - 25),  # 1 tech
            (TeamType.defence, 'Т', '#000000', '#000000', SymbolType.letter, self.center_center_football + 33, - self.player_size / 2 - 25),  # 3 tech
            (TeamType.defence, 'E', '#000000', '#000000', SymbolType.letter, self.center_center_football + 56, - self.player_size / 2 - 25),  # RT
            (TeamType.defence, 'E', '#000000', '#000000', SymbolType.letter, self.center_center_football - 56, - self.player_size / 2 - 25),  # LE
            (TeamType.defence, 'M', '#000000', '#000000', SymbolType.letter, self.center_center_football + 33, - self.player_size / 2 - 50),
            (TeamType.defence, 'S', '#000000', '#000000', SymbolType.letter, self.center_center_football - 33, - self.player_size / 2 - 50),
            (TeamType.defence, 'W', '#000000', '#000000', SymbolType.letter, self.center_center_football - 130, - self.player_size / 2 - 50),
            (TeamType.defence, '$', '#000000', '#000000', SymbolType.letter, self.center_center_football + 130, - self.player_size / 2 - 50),
            (TeamType.defence, 'C', '#000000', '#000000', SymbolType.letter, self.center_center_football + 230, - self.player_size / 2 - 65),  # RC
            (TeamType.defence, 'C', '#000000', '#000000', SymbolType.letter, self.center_center_football - 230, - self.player_size / 2 - 65),  # LC
            (TeamType.defence, 'F', '#000000', '#000000', SymbolType.letter, self.center_center_football, - self.player_size / 2 - 120)
        )
        ...
        self.offence_flag = (
            (TeamType.offence, 'C', '#000000', '#000000', FillType.white, self.center_center_flag, -self.player_size / 2),
            (TeamType.offence, 'X', '#000000', '#000000', FillType.white, self.center_center_flag + self.field_data.flag_width_one_yard * 10, -self.player_size / 2),
            (TeamType.offence, 'Z', '#000000', '#000000', FillType.white, self.center_center_flag - self.field_data.flag_width_one_yard * 10, -self.player_size / 2),
            (TeamType.offence, 'Y', '#000000', '#000000', FillType.white, self.center_center_flag + self.field_data.flag_width_one_yard * 5, -self.player_size / 2),
            (TeamType.offence, 'Q', '#000000', '#000000', FillType.white, self.center_center_flag, -self.player_size / 2 + self.field_data.flag_one_yard * 5)
        )

        self.additional_player_flag = (TeamType.offence_add, 'H', '#000000', '#000000', FillType.white,
                                       self.center_center_football + self.field_data.flag_width_one_yard * 2.5,
                                       - self.player_size / 2)

        self.defence_flag = (
            (TeamType.defence, 'M', '#000000', '#000000', SymbolType.letter, self.center_center_flag, -self.player_size / 2 - self.field_data.flag_one_yard * 7),
            (TeamType.defence, 'C', '#000000', '#000000', SymbolType.letter, self.center_center_flag + self.field_data.flag_width_one_yard * 10, -self.player_size / 2 - self.field_data.flag_one_yard * 5),
            (TeamType.defence, 'C', '#000000', '#000000', SymbolType.letter, self.center_center_flag - self.field_data.flag_width_one_yard * 10, -self.player_size / 2 - self.field_data.flag_one_yard * 5),
            (TeamType.defence, 'S', '#000000', '#000000', SymbolType.letter, self.center_center_flag + self.field_data.flag_width_one_yard * 7, -self.player_size / 2 - self.field_data.flag_one_yard * 9),
            (TeamType.defence, 'S', '#000000', '#000000', SymbolType.letter, self.center_center_flag - self.field_data.flag_width_one_yard * 7, -self.player_size / 2 - self.field_data.flag_one_yard * 9)
        )