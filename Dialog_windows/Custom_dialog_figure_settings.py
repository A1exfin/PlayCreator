...
from .Widgets.Custom_widget_for_figure_settings import CustomWidget
from Enums import Modes

__all__ = ['DialogFigureSettings']
...
class DialogFigureSettings(QDialog):
    ...
    def __init__(self, figure_type: Modes, border: bool, border_color: str, border_width: int,
