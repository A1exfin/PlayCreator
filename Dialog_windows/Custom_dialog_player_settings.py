...
from .Widgets.Custom_buttons_for_player_settings import CustomPushButtonFillType, CustomPushButtonSymbolType
from Enums import FillType, SymbolType

__all__ = ['DialogFirstTeamPlayerSettings', 'DialogSecondTeamPlayerSettings']
...
class DialogPlayerSettings(QDialog):
    ...
    def __init__(self, player_text: str, player_text_color: str, player_color: str, parent=None, flags=Qt.WindowFlags()):
...
class DialogFirstTeamPlayerSettings(DialogPlayerSettings):
    def __init__(self, player_position: str, player_text: str, player_color: str, player_text_color: str, player_fill_type: FillType, parent=None, flags=Qt.WindowFlags()):
        super().__init__(player_text, player_text_color, player_color, parent, flags)
...
class DialogSecondTeamPlayerSettings(DialogPlayerSettings):
    def __init__(self, player_text: str, player_text_color: str, player_color: str, player_symbol: SymbolType, parent=None, flags=Qt.WindowFlags()):
        super().__init__(player_text, player_text_color, player_color, parent=parent)
        self.player_text = player_text
        self.player_color = player_color
        self.player_text_color = player_text_color
